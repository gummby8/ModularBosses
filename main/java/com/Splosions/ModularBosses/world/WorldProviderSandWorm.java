...
public class WorldProviderSandWorm extends WorldProviderSurface {


	public final String saveFolder;
	public ChunkProviderSandWorm chunkProvider;
	
	public WorldProviderSandWorm() {
		setDimension(Dimensions.dimensionID);
		saveFolder = "DIM" + Dimensions.dimensionID;
	}
    ...
    {
		this.worldChunkMgr = new MBWorldChunkManager(worldObj);
        this.dimensionId = Dimensions.dimensionID;
    }
    ...
    public IChunkProvider createChunkGenerator()
    {
    	...
    	if (this.chunkProvider == null) {
	    	this.chunkProvider = new ChunkProviderSandWorm(worldObj, worldObj.getSeed(), worldObj.getWorldInfo().isMapFeaturesEnabled());
	        return this.chunkProvider;
    	} else {
    		return new ChunkProviderSandWorm(worldObj, worldObj.getSeed(), worldObj.getWorldInfo().isMapFeaturesEnabled());
    	}
    }
    
    public ChunkProviderSandWorm getChunkProvider() {
    	return this.chunkProvider;
    }
	...
	public Vec3 getSkyColor(Entity cameraEntity, float partialTicks) {
		return new Vec3(43 / 256.0, 46 / 256.0, 99 / 256.0);
	}
