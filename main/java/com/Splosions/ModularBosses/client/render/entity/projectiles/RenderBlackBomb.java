...
public class RenderBlackBomb extends Render {
	...
	public void doRender(Entity entity, double x, double y, double z, float yaw, float partialTick) {
		...
		miniSun((EntityBlackBomb)entity, scale, x, y, z, partialTick);
	}
    ...
    protected void miniSun(EntityBlackBomb entity, float scale, double x, double y, double z, float partialTick) {
            ...
            renderDragonDeath(entity, 180, 0.0F, 0.0F, 0.0F, partialTick);
            GlStateManager.popMatrix();
            GlStateManager.popMatrix();
    }

    private void renderDragonDeath(EntityBlackBomb spark, float density, float x, float y, float z, float partialTicks) {
