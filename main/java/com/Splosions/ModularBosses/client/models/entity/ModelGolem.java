...
public class ModelGolem extends ModelBase {
	...
	public ModelGolem() {
		...
		FWAIST.set(-25, 24, -22, 0, 46, 39);
		FRARM.set(-100, 42, -28, -3, -51, -63);
		FLARM.set(88, 222, 11.17F, -52, 64, 55);
		FLRShoulder2.set(-200, 90, 50, -55.22F, 60, 23);
		FLFShoulder2.set(160, 200, -200, 45.21F, 56, 44);
		FRFShoulder2.set(-90, 120, -60, 38.2F, 60, -35);
		FRRShoulder2.set(-50, 200, 90, -47.2F, 50, -33);
		FRFShoulder1.set(100, 200, -200, 59.5F, 50, -58.5F);
		FRRShoulder1.set(200, 200, 90, -40, 70, -43.5F);
		FLRShoulder1.set(120, 200, 160, -15.5F, 55, 35.5F);
		FLFShoulder1.set(230, 170, 100, 32.52F, 50, 29.5F);
		FRChest.set(-222, 222, 111, 0, 60, -49);
		FLChest.set(220, -170, 160, 0, 60, 63);
		FHEAD.set(33, 48, 160, 70, 54, 0);
		FRArm1.set(81, -91, -55, -63.98F, 93, 46.01F);
		FRArm2.set(200, 190, 55, 13.02F, 90, 0.01F);
		FLArm1.set(80, 120, 194.78F, -48.98F, 74, -59.99F);
		FLArm2.set(30, 88, 112.17F, 49.02F, 87, 40.01F);
		FLFHip.set(140, -170, 112, 26.5F, 49, -51.5F);
		FLLEG.set(200, 200, 200, -20, 42, 20);
		FRLEG.set(100, 150, 10, 35, 63, -26);
		FRRHip.set(222, 111, 200, -41.5F, 53, 37.5F);
		FLRHip.set(220, 111, 111, -40.52F, 53, -50.5F);
		FRFHip.set(-200, 70, -80, 27.52F, 50, 42.5F);
		FLLeg1.set(100, 201, 0, 12.02F, 38.3F, 13.5F);
		FLLeg2.set(100, -100, 50, 22.01F, 48, -20.99F);
		FRLeg1.set(100, 201, 0, 12.02F, 38.3F, 13.5F);
		FRLeg2.set(56, -50, 200, -34.99F, 56, -10.99F);
