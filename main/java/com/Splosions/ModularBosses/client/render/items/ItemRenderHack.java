...
public class ItemRenderHack {
	...
	public static boolean renderItem(ItemStack stack, EntityLivingBase elb, ItemCameraTransforms.TransformType transform, boolean leftHanded){
		...
		if (!stack.isEmpty() && stack.getItem() instanceof IItemMBRenderer){
			IItemMBRenderer item = (IItemMBRenderer) stack.getItem();
	 ...
	 * @return
	 */
	protected static boolean JEI_Fix(ItemCameraTransforms.TransformType type, boolean leftHanded, IItemMBRenderer item, ItemStack stack) {
