...
public class EntitySkull extends EntityFlying implements IMob {
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.FOLLOW_RANGE).setBaseValue(skullFollowDistance);
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(skullMaxHealth);
	}
