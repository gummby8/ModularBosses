package com.Splosions.ModularBosses.client.particle;
...
public class MagicFX extends EntityCrit2FX {
	   float field_174839_a;
	    private static final String __OBFID = "CL_00000899";

	    public MagicFX(World worldIn, double p_i46284_2_, double p_i46284_4_, double p_i46284_6_, double p_i46284_8_, double p_i46284_10_, double p_i46284_12_)
	    {
	        this(worldIn, p_i46284_2_, p_i46284_4_, p_i46284_6_, p_i46284_8_, p_i46284_10_, p_i46284_12_, 1.0F);
	    }

	    public MagicFX(World worldIn, double x, double y, double z, double motX, double motY, double motZ, float time)
	    {
	        super(worldIn, x, y, z, 0.0D, 0.0D, 0.0D);
	        this.motionX *= 0.10000000149011612D;
	        this.motionY *= 0.10000000149011612D;
	        this.motionZ *= 0.10000000149011612D;
	        this.motionX += motX * 0.4D;
	        this.motionY += motY * 0.4D;
	        this.motionZ += motZ * 0.4D;
	    ...
	    public static class Factory implements IParticleFactory
	        {
	            ...
	            {
	                return new MagicFX(worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
	            }
	        }
	    ...
	    public static class MagicFactory implements IParticleFactory
	        {
	            ...
	            public EntityFX getEntityFX(int p_178902_1_, World worldIn, double p_178902_3_, double p_178902_5_, double p_178902_7_, double p_178902_9_, double p_178902_11_, double p_178902_13_, int ... p_178902_15_)
	            {
	                EntityCrit2FX entitycrit2fx = new MagicFX(worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
