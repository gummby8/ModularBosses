...
public class TileEntityTempWormBlood extends TileEntity implements ITickable {
	...
	public void update() {
		...
		if (this.ticksExisted > 100 && !this.world.isRemote) {
			...
			IBlockState state = ModFluids.FLUID_TEMP_WORM_BLOOD.getBlock().getDefaultState().withProperty(BlockFluidBase.LEVEL, 0);
